...
class Title: Decodable, Identifiable, Hashable {
    ...
    required init(from decoder: any Decoder) throws {
        ...
        title = try container.decodeIfPresent(String.self, forKey: .overview)
        title = try container.decodeIfPresent(String.self, forKey: .posterPath)
